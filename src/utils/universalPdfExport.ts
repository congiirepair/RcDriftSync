...
function sectionsFor(tune: Tune, car: Car): UniversalPdfSection[] {
  const sections: UniversalPdfSection[] = [
    ...
    { title: "RDX Sheet - Header", rows: rowsFor([["Driver", "driver"], ["Driving place", "track"], ["Surface", "surface"], ["Body", "body"], ["Wing", "wing"], ["Tires", "tires"]]) },
    { title: "RDX Sheet - Front Spacer Zones", rows: rowsFor([["Bell crank position", "bellcrankAckermanHole"], ["Front ball caps", "frontBallCaps"], ["Upper arm outer spacer", "frontUpperArmSpacer"], ["Upper arm inner front spacer", "frontUpperArmInnerFrontSpacer"], ["Upper arm inner rear spacer", "frontUpperArmInnerRearSpacer"], ["Lower arm outer spacer", "frontLowerArmSpacer"], ["Lower arm inner front spacer", "frontLowerArmInnerFrontSpacer"], ["Lower arm inner rear spacer", "frontLowerArmInnerRearSpacer"], ["Shock upper spacer", "frontShockTowerSpacer"], ["Shock lower spacer", "frontLowerShockSpacer"], ["Upper ball stud", "frontUpperBallStud"], ["Lower ball stud", "frontLowerBallStud"], ["Knuckle upper spacer", "frontKnuckleTopSpacer"], ["Knuckle steering spacer", "frontKnuckleSteeringLinkSpacer"], ["Knuckle lower spacer", "frontKnuckleBottomSpacer"], ["Lower sus-mount side", "frontLowerSusMountSide"], ["Front wheel hubs", "frontWheelHubType"], ["Front wheel hub spacer", "frontWheelHubSpacer"], ["Knuckle stopper", "frontKnuckleStopper"]]) },
    { title: "RDX Sheet - Front Shock", rows: rowsFor([["Front shock", "frontDamper"], ["Shock / shaft", "frontShockShaft"], ["Spring", "frontSpring"], ["Piston holes", "frontPistonHoles"], ["Piston diameter", "frontPistonDiameter"], ["Oil", "frontShockOil"], ["O-ring", "frontOring"], ["Retainer", "frontRetainer"]]) },
    { title: "RDX Sheet - Rear Spacer Zones", rows: rowsFor([["Motor position", "motorPosition"], ["RF sus mount type", "rfSusMountType"], ["RF sus mount number", "rearSusMountNumber"], ["RF sus mount flipped", "rearSusMountFlipped"], ["RR sus mount type", "rrSusMountType"], ["RR sus mount number", "rrSusMountNumber"], ["RF insert / dot position", "rfSusMountPosition"], ["RR insert / dot position", "rrSusMountPosition"], ["RF spacer under sus mount", "spacerUnderSusMountRF"], ["RR spacer under sus mount", "spacerUnderSusMountRR"], ["Rear lower arm", "rearSusArm"], ["Rear hub carrier", "rearHubCarrierType"], ["Rear wheel hubs", "rearWheelHubType"], ["Rear wheel hub spacer", "rearWheelHubSpacer"], ["Lower sus hole position", "lowerSusHolePosition"], ["Diff", "diffType"], ["RD-012 upper link hole", "rearHubCarrierUpperLinkHole"], ["RD-012 lower / axle hole", "rearHubCarrierLowerLinkHole"], ["Rear hub upper link spacer", "rearHubCarrierUpperLinkSpacer"], ["Rear hub lower / axle spacer", "rearHubCarrierLowerLinkSpacer"], ["Rear skid / camber angle", "rearSkidAngle"], ["Rear hub and damper notes", "rearGeometryNotes"]]) },
    { title: "RDX Sheet - Rear Shock", rows: rowsFor([["Rear shock", "rearDamper"], ["Shock / shaft", "rearShockShaft"], ["Spring", "rearSpring"], ["Piston holes", "rearPistonHoles"], ["Piston diameter", "rearPistonDiameter"], ["Oil", "rearShockOil"], ["O-ring", "rearOring"], ["Retainer", "rearRetainer"]]) },
    { title: "RDX Sheet - Wheels and Electrical", rows: rowsFor([["Front wheel", "frontWheel"], ["Front wheel offset", "frontWheelOffset"], ["Rear wheel", "rearWheel"], ["Rear wheel offset", "rearWheelOffset"], ["Servo", "servoModel"], ["Servo horn length", "servoHornLength"], ["Servo position", "servoPosition"], ["Gyro", "gyroModel"], ["Gyro gain", "gyroGain"], ["Gyro curve / carve", "gyroCurve"], ["Motor", "motorModel"], ["Motor timing", "motorTiming"], ["Battery", "battery"], ["ESC", "escModel"], ["Pinion gear", "pinionGear"], ["Spur gear", "spurGear"], ["Boost", "boostTiming"], ["Turbo", "turboTiming"]]) },
