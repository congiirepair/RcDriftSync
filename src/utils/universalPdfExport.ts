  ...
  const sections: UniversalPdfSection[] = [
    ...
    },
    {
      ...
      rows: [
        ...
        { label: "Track condition", fieldId: "trackConditionPreset" },
        { label: "Track temperature", fieldId: "trackTemperature" },
        { label: "Layout speed", fieldId: "layoutSpeed" },
    ...
    { title: "Geometry", rows: rowsFor([["Ride height", "frontRideHeight"], ["Camber", "frontCamber"], ["Toe", "frontToe"], ["Caster", "caster"], ["KPI", "kpi"], ["Ackerman", "ackerman"], ["Steering angle", "steeringAngle"], ["Track width", "frontTrackWidth"], ["Bell crank position", "bellcrankAckermanHole"], ["Front ball caps", "frontBallCaps"], ["Upper arm / link", "frontUpperLink"], ["Lower arm", "frontLowerArm"], ["Upper arm outer spacer", "frontUpperArmSpacer"], ["Upper arm inner front spacer", "frontUpperArmInnerFrontSpacer"], ["Upper arm inner rear spacer", "frontUpperArmInnerRearSpacer"], ["Lower arm outer spacer", "frontLowerArmSpacer"], ["Lower arm inner front spacer", "frontLowerArmInnerFrontSpacer"], ["Lower arm inner rear spacer", "frontLowerArmInnerRearSpacer"], ["Upper ball stud", "frontUpperBallStud"], ["Lower ball stud", "frontLowerBallStud"], ["Knuckle", "frontKnuckle"], ["Knuckle plate", "frontKnucklePlate"], ["Knuckle upper spacer", "frontKnuckleTopSpacer"], ["Knuckle steering spacer", "frontKnuckleSteeringLinkSpacer"], ["Knuckle lower spacer", "frontKnuckleBottomSpacer"], ["Knuckle stopper", "frontKnuckleStopper"], ["Lower sus-mount side", "frontLowerSusMountSide"], ["Front wheel hubs", "frontWheelHubType"], ["Front wheel hub spacer", "frontWheelHubSpacer"], ["Trail / steering notes", "trail"], ["Bump steer notes", "bumpSteerNotes"], ["FF suspension mount", "ffToeBlock"], ["FF insert / spacer notes", "ffToeBlockInsertNotes"], ["FR suspension mount", "frToeBlock"], ["FR insert / spacer notes", "frToeBlockInsertNotes"], ["Spacer notes", "frontSpacerNotes"], ["Memo", "frontMemo"]]) },
    { title: "Shock Setup", rows: rowsFor([["Front shock", "frontDamper"], ["Shock / shaft", "frontShockShaft"], ["Spring", "frontSpring"], ["Piston", "frontPiston"], ["Piston holes", "frontPistonHoles"], ["Piston diameter", "frontPistonDiameter"], ["Oil", "frontShockOil"], ["O-ring", "frontOring"], ["Retainer", "frontRetainer"], ["Shock position", "frontShockPosition"], ["Shock upper spacer", "frontShockTowerSpacer"], ["Shock lower spacer", "frontLowerShockSpacer"], ["Droop", "frontDroop"], ["Preload", "frontPreload"], ["Rebound", "frontRebound"], ["Mounting notes", "frontDamperMountingNotes"]]) },
    { title: "Rear Geometry", rows: rowsFor([["Ride height", "rearRideHeight"], ["Camber", "rearCamber"], ["Toe", "rearToe"], ["Skid angle", "skidAngle"], ["Skid / camber angle", "rearSkidAngle"], ["Roll center", "rearRollCenter"], ["Track width", "rearTrackWidth"], ["Sway bar", "rearSwayBar"], ["Sway bar thickness", "rearSwayBarThickness"], ["Upper arm / link", "rearUpperLink"], ["Lower arm", "rearLowerArm"], ["Lower arm side", "rearLowerArmSide"], ["Rear lower arm callout", "rearSusArm"], ["Hub carrier", "rearHubCarrier"], ["Hub carrier type", "rearHubCarrierType"], ["Rear hub upper link hole", "rearHubCarrierUpperLinkHole"], ["Rear hub lower / axle hole", "rearHubCarrierLowerLinkHole"], ["Rear hub upper link spacer", "rearHubCarrierUpperLinkSpacer"], ["Rear hub lower / axle spacer", "rearHubCarrierLowerLinkSpacer"], ["Lower sus hole position", "lowerSusHolePosition"], ["Rear axle height / hole notes", "rearAxleHeightNotes"], ["RF suspension mount", "rfToeBlock"], ["RF sus mount bushing", "rfSusMountType"], ["RF sus mount part / number", "rearSusMountNumber"], ["RF sus mount flipped", "rearSusMountFlipped"], ["RF bushing position", "rfSusMountPosition"], ["RF insert / spacer notes", "rfToeBlockInsertNotes"], ["RF spacer under sus mount", "spacerUnderSusMountRF"], ["RR suspension mount", "rrToeBlock"], ["RR sus mount bushing", "rrSusMountType"], ["RR sus mount part / number", "rrSusMountNumber"], ["RR bushing position", "rrSusMountPosition"], ["RR insert / spacer notes", "rrToeBlockInsertNotes"], ["RR spacer under sus mount", "spacerUnderSusMountRR"], ["Rear wheel hubs", "rearWheelHubType"], ["Rear wheel hub spacer", "rearWheelHubSpacer"], ["Anti-squat / skid notes", "rearAntiSquatNotes"], ["Rear hub and damper notes", "rearGeometryNotes"], ["Spacer notes", "rearSpacerNotes"], ["Memo", "rearMemo"]]) },
    { title: "Rear Shock Setup", rows: rowsFor([["Rear shock", "rearDamper"], ["Shock / shaft", "rearShockShaft"], ["Spring", "rearSpring"], ["Piston", "rearPiston"], ["Piston holes", "rearPistonHoles"], ["Piston diameter", "rearPistonDiameter"], ["Oil", "rearShockOil"], ["O-ring", "rearOring"], ["Retainer", "rearRetainer"], ["Shock position", "rearShockPosition"], ["Shock mounting notes", "rearShockMountingNotes"], ["Droop", "rearDroop"], ["Preload", "rearPreload"], ["Rebound", "rearRebound"]]) },
    { title: "Tires / Wheels", rows: rowsFor([["Front tire", "frontTire"], ["Front tire compound", "frontTireCompound"], ["Front tire diameter", "frontTireDiameter"], ["Rear tire", "rearTire"], ["Rear tire compound", "rearTireCompound"], ["Rear tire diameter", "rearTireDiameter"], ["Tire prep notes", "tirePrepNotes"], ["Tire wear notes", "tireWearNotes"], ["Front wheel", "frontWheel"], ["Front wheel width", "frontWheelWidth"], ["Front wheel offset", "frontWheelOffset"], ["Rear wheel", "rearWheel"], ["Rear wheel width", "rearWheelWidth"], ["Rear wheel offset", "rearWheelOffset"]]) },
    { title: "Drivetrain", rows: rowsFor([["Motor position", "motorPosition"], ["Differential type", "diffType"], ["Ball diff setting", "ballDiffSetting"], ["Gear diff oil", "gearDiffOil"], ["Diff grease", "diffGrease"], ["LSD setting", "lsdSetting"], ["Spur gear", "spurGear"], ["Pinion gear", "pinionGear"], ["Gear pitch", "gearPitch"], ["Internal ratio", "internalDriveRatio"], ["Final drive ratio", "finalDriveRatio"], ["Belt / shaft notes", "beltShaftNotes"], ["Memo", "drivetrainMemo"]]) },
    { title: "Body / Weight", rows: rowsFor([["Body shell", "bodyShell"], ["Body mount position", "bodyMountPosition"], ["Body height", "bodyHeight"], ["Body weight", "bodyWeight"], ["Wing", "aeroWing"], ["Wing position", "wingPosition"], ["Aero notes", "aeroNotes"], ["Battery position", "batteryPosition"], ["Added weight", "addedWeight"], ["Weight location", "weightLocation"], ["Front weight notes", "frontWeight"], ["Rear weight notes", "rearWeight"], ["Side weight notes", "sideWeight"], ["Weight balance notes", "weightBalanceNotes"], ["Chassis brace", "chassisBrace"]]) },
